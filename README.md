...
The list of `monsterBehavior` message IDs to be silenced is located inside `/lib/npcBalloonData.json/`. As of mod release, This list contains all message IDs that are not balloon only. You're free to edit this file manually if you know what you're doing. Array elements removed from this file will be unsilenced.
